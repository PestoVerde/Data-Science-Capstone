...
In this capstone we will work on understanding and building predictive text models for smart keyboard like those produced by [SwiftKey](https://swiftkey.com/en). To do so we are going to use three set of English texts of three different type - blogs, news and twits. The data is from a corpus called [HC Corpora](www.corpora.heliohost.org).
...
To keep the paper compact, we do not echo all the code. To see complete code, please visit [github page](   dndn cojef coe  efj jf j j  ). All function we use could be found in **Appendix** below.
